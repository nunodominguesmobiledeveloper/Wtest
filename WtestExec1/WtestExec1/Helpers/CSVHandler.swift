...
public class CSVHandler {
    ...
    var delimiter: CharacterSet = CharacterSet(charactersIn: ",")
    ...
    public convenience init(contentsOfData data: Data) throws {
        let comma = CharacterSet(charactersIn: ",")
        let csvString: String?
            csvString = String(data: data, encoding: String.Encoding.utf8)
